...
# read in data 
data <- read_csv(file.path(path,'welfare_carbontaxUS_l_50.csv'))
...
p1 <- ggplot() +
  ...
  labs(
    ...
    subtitle = "from a $50/ton carbon tax in the US"
  ) +
  theme_minimal() +
  theme(
...
savename <- 'welfare_carbontaxUSA_50usd_map.png'
...
savename <- 'welfare_carbontaxUSA_50usd_bar.png'
